            ...
            public void actionPerformed(ActionEvent ae)
            {
               ...
               // System.out.println(pass);
            	...
            	if(!(namet.getText().equals("")) && !(addresst.getText().equals("")) && !(districtt.getText().equals("")) && !(statet.getText().equals("")) && !(pincodet.getText().equals("")) && !(dobt.getText().equals("")) && !(fathert.getText().equals("")) && !(mothert.getText().equals("")) && !(emailt.getText().equals("")) )
                {
                   ...
                   // f.dispose();
                    //new app();
            		if(percent >= 80.0 && income<=500000.0)
            		{
            			res="Congratulations...You got MHRD Scholarship , Central Sector Scholarship";
            		}
            		else if(percent >= 80.0 && income<=800000.0)
            		{
            			res="Congratulations...You got MHRD Scholarship";
            		}
            		else if(percent>=70 && income<=300000.0)
            		{
            			res="Congratulations...You got Tata Scholarship";
            		}
            		else if(percent>=65 && income<=300000.0)
            		{
            			res="Congratulations...You got Minority Scholarship";
            		}
            		else if(percent>=60 && income<=100000.0)
            		{
            			res="Congratulations...You got LIC GJ Scholarship and KVPY Scholarship";
            		}
            		else if(percent>=60 && income<=200000.0)
            		{
            			res="Congratulations...You got KVPY Scholarship";
            		}
            		else
            		{
            			res = "Sorry...You are not eligible for any Scholarship";
            		}
